...
from exilelens.gear.models import PoolState, SlotPoolEntry
from exilelens.gear.slots import GEAR_OPTIMIZER_SLOTS, GEAR_SLOT_LABELS, pob_slot_for_product
from exilelens.market.models import MarketCandidatePool
...
class CandidatePoolRegistry:
    ...
    def register_from_search_result(self, result: dict[str, Any]) -> None:
        ...
        from exilelens.market.models import MarketCandidateResult, CandidateEvaluation, CandidateListing, CandidateIdentity
