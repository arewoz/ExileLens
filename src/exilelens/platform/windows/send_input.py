...
from exilelens.platform.windows.foreground_info import (
    evaluate_poe_foreground_match,
    get_foreground_window_info,
)
from exilelens.platform.windows.keyboard_state import is_shift_physically_down, keyboard_modifier_snapshot
from exilelens.platform.windows.low_level_keyboard import EXILELENS_INJECT_TAG
...
def send_ctrl_c_to_foreground(
    *,
    ...
    from exilelens.security_audit import send_input_disabled
    ...
    from exilelens.platform.windows.low_level_keyboard import hook_modifier_snapshot
...
def probe_send_ctrl_c(*, require_poe_foreground: bool = True) -> dict[str, Any]:
    ...
    from exilelens.platform.windows.clipboard_identity import read_clipboard_sequence_number
