...
from exilelens.analysis.probes import ProbeEngine, clone_item_with_mods, detect_breakpoints, score_probe_metrics
from exilelens.items.blocker_solver import (
    RepairVector,
...
from exilelens.items.decision import RecommendationStyle
from exilelens.items.item_check_settings import UpgradePotentialMode
from exilelens.items.upgrade_path import (
    UpgradePathState,
    build_why_not_upgrade,
    classify_upgrade_path_state,
)
from exilelens.items.offense_coverage import PotentialDimensionEvidence, dimension_eligible
