...
def _delta_line(delta: dict[str, Any]) -> str:
    from exilelens.items.compact_tooltip import impact_marker
...
def _damage_reference_section(model: dict[str, Any], outcome: dict[str, Any]) -> dict[str, Any] | None:
    from exilelens.items.primary_metric import build_damage_reference, format_damage_reference_lines
...
def _key_impact(model: dict[str, Any], outcome: dict[str, Any]) -> dict[str, Any] | None:
    from exilelens.items.compact_tooltip import impact_marker, rows_from_outcome_deltas, select_impact_rows
...
def _slot_lines(model: dict[str, Any]) -> list[dict[str, Any]]:
    from exilelens.items.compact_tooltip import slot_verdict_lines
