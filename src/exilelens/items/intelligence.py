...
from exilelens.items.best_slot import best_slot_label, rank_comparisons_guardrail_first, select_best_comparison
from exilelens.items.build_intel.engine import attach_build_intelligence
from exilelens.items.decision import RecommendationStyle, build_decision_summary
from exilelens.items.multi_profile import score_all_profiles
from exilelens.items.presentation import PopupDensity, build_presentation
