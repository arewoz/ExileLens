...
from exilelens.items.display_thresholds import DEFAULT_DISPLAY_THRESHOLDS, is_display_worthy
from exilelens.items.formatting import format_current_candidate, format_metric_delta
from exilelens.items.presentation_copy import (
...
from exilelens.items.upgrade_path import build_repair_steps
...
def build_presentation(
    ...
    *,
    ...
    return {
        ...
        "paired_offhand_cleared": bool(result.get("paired_offhand_cleared")),
        "paired_offhand_slot": str(result.get("paired_offhand_slot") or ""),
        "paired_offhand_name": str(result.get("paired_offhand_name") or ""),
