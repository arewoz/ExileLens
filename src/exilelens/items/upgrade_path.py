...
from exilelens.items.presentation_copy import dedupe_reason_blocks, should_show_why_not_section, why_section_title
...
def attach_upgrade_path_presentation(
    ...
    *,
    ...
    from exilelens.items.presentation import sync_presentation_current_edge
