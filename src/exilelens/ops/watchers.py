...
from exilelens.ops.compatibility import load_manifest, mark_needs_verification
from exilelens.ops.models import CompatibilityStatus
from exilelens.ops.patch_impact import parse_notes_text
...
def watch_pob(*, pob_path: Path | None = None, fetch_remote: bool = False) -> dict[str, Any]:
    ...
    payload["entry_point"] = "python -m exilelens ops pob-compatibility"
