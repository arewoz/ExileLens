...
from exilelens.ops.models import CompatibilityStatus, GateVerdict, Severity
    ...
    *,
    ...
    try:
        ...
        if manifest.game_status == CompatibilityStatus.BROKEN.value:
            ...
            next_actions.append("Run: python -m exilelens ops game-update --notes <patch-notes.txt>")
    ...
    if smoke_result is None:
        next_actions.append("Run: python -m exilelens ops smoke")
