...
This replaces :class:`~exilelens.price_check.market_drivers.MarketPriceDriver` as the
...
Deciding what matters is :mod:`exilelens.price_check.desirability`'s job, and there is
...
from exilelens.price_check.market_drivers import parse_equipment_properties, tagged_mod_lines
from exilelens.price_check.mod_tier import TierRange, parse_tier_range, tier_range_for_value
from exilelens.price_check.stat_registry import DriverKind, get_family, trade_stat_ids
...
class MarketRole(str, Enum):
    ...
    Distinct from :class:`exilelens.price_check.comparable_features.MarketRole`, which
