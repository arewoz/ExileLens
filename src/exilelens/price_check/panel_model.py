...
from exilelens.price_check.base_value import BaseValueProfile, CraftingMode
from exilelens.price_check.comparable_features import normalize_mod_text
from exilelens.price_check.market_mod import Direction, MarketMod, MarketRole, ModSource
from exilelens.price_check.market_plan import (
...
from exilelens.price_check.market_profiles import BaseRelevance
...
def comparable_rows_from_estimate(estimate: Any, plan: MarketSearchPlan | None) -> tuple[ComparableRow, ...]:
    ...
    alone.
    """
    from exilelens.price_check.market_mod import extract_market_mods
    from exilelens.price_check.presentation import format_comparable_price
