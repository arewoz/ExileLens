...
from exilelens.app.settings import AppSettings, OverlayPositionMode
from exilelens.items.presentation import (
    PopupDensity,
    SurfaceMode,
    build_presentation,
)
from exilelens.items.presentation import has_passive_detail_drawer
from exilelens.ui.overlay_aux_companion import AuxEdgeCompanion
from exilelens.ui.overlay_aux_policy import (
...
from exilelens.ui.overlay_geometry import max_overlay_height_logical
from exilelens.ui.overlay_positioning import OverlayExpansionPlan, apply_expansion_plan, compute_overlay_placement, plan_overlay_expansion
from exilelens.ui.overlay_presentation import ItemOverlayPanel, PriceCheckPanel
from exilelens.ui.overlay_visibility import (
    OverlayHideReason,
...
class OverlayWindow(QWidget):
    ...
    def _apply_fixed_corner(self) -> None:
        ...
        screen = None
        try:
            from exilelens.platform.windows.poe_window import poe_client_geometry
        ...
        self._aux_companion.hide()
        from exilelens.ui.overlay_positioning import OverlayPlacement
    ...
    def remember_position(self) -> None:
        if self.settings.overlay_position_mode != OverlayPositionMode.FIXED_CORNER.value:
            return
        pos = self.pos()
        from exilelens.app.settings import OverlayPosition
