...
from exilelens.items.diagnostics import serialize_item_diagnostics
from exilelens.items.more_info import ADVANCED_SECTION_IDS, more_info_for_choice
from exilelens.ui.styles import EMPHASIS_DELTA_COLOR, OVERLAY_WARNING_BODY, VERDICT_CLASS, VERDICT_COLOR
