...
and records why. The answer is a :class:`~poe2value.price_check.market_mod.MarketRole`,
...
from poe2value.price_check.base_value import BaseValueProfile, build_base_profile
from poe2value.price_check.defence_semantics import (
    DefencePropertyAssessment,
    assess_defence_properties,
    local_component_mod_ids,
)
from poe2value.price_check.market_profiles import (
    is_known_dead_mod,
