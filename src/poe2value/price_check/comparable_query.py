...
if TYPE_CHECKING:
    from poe2value.price_check.market_plan import CompiledTradeQuery
...
from poe2value.price_check.feature_fallback import (
    EconomicIdentity,
    IdentitySource,
    select_economic_identity,
)
from poe2value.price_check.market_drivers import PriceCheckHypothesis, build_auto_hypothesis
