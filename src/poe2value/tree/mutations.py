...
from poe2value.errors import EngineError, RestoreFailed, WorkerUnhealthy
...
from poe2value.tree.fingerprint import path_identity, tree_fingerprint_from_components
from poe2value.tree.graph import classify_target, shortest_path
from poe2value.tree.models import EvalStatus, PassiveTreeSnapshot, TreeBaseline
from poe2value.tree.value import evaluation_payload, score_tree_metrics

YieldFn = Callable[[], bool]


def decorate_tree_evaluation(result: dict[str, Any]) -> dict[str, Any]:
    from poe2value.worker import decorate_evaluation
    ...
    def evaluate_path(
        ...
        *,
        ...
        if should_yield and should_yield():
            from poe2value.analysis.pipeline import AnalysisYielded
...
def load_tree_snapshot(
    ...
    *,
    ...
    from poe2value.tree.models import snapshot_from_payload
