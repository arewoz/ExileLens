...
from poe2value.platform.windows.cursor import monitor_work_area_at_physical
from poe2value.platform.windows.poe_window import physical_to_logical
from poe2value.ui.overlay_positioning import OverlayPlacement, _resolve_anchor_physical
