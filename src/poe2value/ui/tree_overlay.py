...
from poe2value.platform.windows.poe_window import (
    PoeClientGeometry,
    describe_widget_hwnd,
    poe_client_geometry,
    set_hwnd_topmost,
)
from poe2value.tree.overlay_frame import LiveTreeOverlayFrame, OverlayAppearance, OverlayMarker
from poe2value.tree.overlay_mode import OverlayMode
from poe2value.tree.transform import TreeOverlayCalibration, TreeScreenTransform, current_display_env
...
def frame_from_model(
    ...
    *,
    ...
    from poe2value.tree.overlay_frame import compose_overlay_frame
